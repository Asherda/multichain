...
var _ = Describe("Gas", func() {
	Context("when estimating verus network fee", func() {
		It("should work", func() {
			...
			gasEstimator1 := verus.NewGasEstimator(client, 1, pack.NewU256FromUint64(fallback1))
			...
			gasEstimator2 := verus.NewGasEstimator(client, 10, pack.NewU256FromUint64(fallback2))
			...
			gasEstimator3 := verus.NewGasEstimator(client, 100, pack.NewU256FromUint64(fallback3))
