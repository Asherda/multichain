...
func DefaultClientOptions() ClientOptions {
	return bitcoin.DefaultClientOptions().WithHost("http://127.0.0.1:45255")
}
...
// BuildTx returns a simple Verus transaction that consumes the funds from the
...
// Tx represents a simple Verus transaction that implements the Bitcoin Compat
// API.
type Tx struct {
	inputs     []utxo.Input
